...
### Added
- Populated coordinates for all waypoints in `RouteDetailProvider`.

## [1.1.1] - 2025-04-05

### Fixed

- Corrected map initial view to center on Day 1 destination after starting journey.
- Enabled the map view 'Home' button to center on the Day 0 start location (St. Jean Pied de Port).
