...
public struct CaminoDestination: Identifiable, Hashable {
    ...
    public static let allDestinations: [CaminoDestination] = [
        ...
        CaminoDestination(day: 22, date: Self.dateFormatter.date(from: "2025-05-22")!, locationName: "León", hotelName: "Hotel Alda Vía León", 
        ...
        CaminoDestination(day: 24, date: Self.dateFormatter.date(from: "2025-05-24")!, locationName: "Chozas de Abajo", hotelName: "Albergue San Antonio de Padua", 
            coordinate: CLLocationCoordinate2D(latitude: 42.4980, longitude: -5.6860),
            dailyDistance: 22.0,
            cumulativeDistance: 477.0,
            elevationProfile: [],
            content: "From Hotel Alda Vía León, head southwest, taking the alternate Villar de Mazarife route. Pass La Virgen del Camino (7 km) and diverge to Villar de Mazarife (20 km). Arrive in Chozas de Abajo (22 km). Your accommodation is located at Camino León 33, about 100 meters from the Camino."),
        
        CaminoDestination(day: 25, date: Self.dateFormatter.date(from: "2025-05-25")!, locationName: "Astorga", hotelName: "Hotel Astur Plaza", 
        ...
        CaminoDestination(day: 26, date: Self.dateFormatter.date(from: "2025-05-26")!, locationName: "Rabanal del Camino", hotelName: "Hotel Rural Casa Indie", 
        ...
        CaminoDestination(day: 27, date: Self.dateFormatter.date(from: "2025-05-27")!, locationName: "Ponferrada", hotelName: "Hotel El Castillo", 
        ...
        CaminoDestination(day: 28, date: Self.dateFormatter.date(from: "2025-05-28")!, locationName: "Villafranca del Bierzo", hotelName: "Hostal Tres Campanas", 
        ...
        CaminoDestination(day: 29, date: Self.dateFormatter.date(from: "2025-05-29")!, locationName: "O Cebreiro", hotelName: "Casa Navarro", 
        ...
        CaminoDestination(day: 30, date: Self.dateFormatter.date(from: "2025-05-30")!, locationName: "Triacastela", hotelName: "Complexo Xacobeo", 
        ...
        CaminoDestination(day: 31, date: Self.dateFormatter.date(from: "2025-05-31")!, locationName: "Sarria", hotelName: "Hotel Mar de Plata", 
        ...
        CaminoDestination(day: 32, date: Self.dateFormatter.date(from: "2025-06-01")!, locationName: "Portomarín", hotelName: "Casona Da Ponte Portomarín", 
        ...
        CaminoDestination(day: 33, date: Self.dateFormatter.date(from: "2025-06-02")!, locationName: "Palas de Rei", hotelName: "Hotel Mica", 
        ...
        CaminoDestination(day: 34, date: Self.dateFormatter.date(from: "2025-06-03")!, locationName: "Arzúa", hotelName: "Hotel Arzúa", 
        ...
        CaminoDestination(day: 35, date: Self.dateFormatter.date(from: "2025-06-04")!, locationName: "A Rúa", hotelName: "Hotel Rural O Acivro", 
        ...
        CaminoDestination(day: 36, date: Self.dateFormatter.date(from: "2025-06-05")!, locationName: "Santiago de Compostela", hotelName: "Hotel Alda Avenida", 
