...
public struct CaminoDestination: Identifiable, Hashable {
    ...
    public static let allDestinations: [CaminoDestination] = [
        ...
        CaminoDestination(day: 30, date: Self.dateFormatter.date(from: "2025-05-31")!, locationName: "Triacastela", hotelName: "Complexo Xacobeo",
            ...
            content: "From Casa Navarro, head west along the Camino. Pass Hospital da Condesa (2 km), Alto do Poio (7 km), and Fonfría (10 km). Descend to Triacastela (21 km). Your accommodation is located at Rúa Santiago 8, about 200 meters."),

        // MARK: - Add Missing Days 31-36 from Route&HotelView_v2.txt
        ...
        CaminoDestination(day: 31, date: Self.dateFormatter.date(from: "2025-06-01")!, locationName: "Sarria", hotelName: "Hotel Mar de Plata",
            ...
            content: "From Complexo Xacobeo, head south along the Camino (San Xil route). Ascend to San Xil (6 km), descend via Furela (12 km) and Pintín (15 km). Arrive in Sarria (18.5 km) via Rúa Maior. Your accommodation is located at Calle de los Formigueiros 5, about 300 meters."),
        ...
        CaminoDestination(day: 32, date: Self.dateFormatter.date(from: "2025-06-02")!, locationName: "Portomarín", hotelName: "Casona Da Ponte Portomarín",
            ...
            content: "From Hotel Mar de Plata, head south along Rúa Maior, following Camino signs. Pass Barbadelo (4 km), Ferreiros (10 km), and descend to the Miño River. Cross the bridge and climb to Portomarín (22 km). Your accommodation is located at Camiño da Capela 10, about 200 meters."),
        ...
        CaminoDestination(day: 33, date: Self.dateFormatter.date(from: "2025-06-03")!, locationName: "Palas de Rei", hotelName: "Hotel Mica",
            ...
            content: "From Casona Da Ponte Portomarín, head east along the Camino. Pass Gonzar (8 km), Castromaior (12 km), and Hospital da Cruz (15 km). Arrive in Palas de Rei (25 km). Your accommodation is located at Rúa Cruceiro, 12, about 300 meters."),
        ...
        CaminoDestination(day: 34, date: Self.dateFormatter.date(from: "2025-06-04")!, locationName: "Arzúa", hotelName: "Hotel Arzúa",
            ...
            content: "From Hotel Mica, head east along the Camino. Pass San Xulián (4 km), Melide (14 km, all services), and Boente (20 km). Arrive in Arzúa (29 km). Your accommodation is located at Rúa Lugo, 132, about 200 meters."),
        ...
        CaminoDestination(day: 35, date: Self.dateFormatter.date(from: "2025-06-05")!, locationName: "A Rúa", hotelName: "Hotel Rural O Acivro",
            ...
            content: "From Hotel Arzúa, head southwest along the Camino. Pass Preguntoño (5 km), Salceda (11 km), and Santa Irene (15 km). Arrive in A Rúa (19 km), near O Pedrouzo. Your accommodation is located at Lugar Rúa, 28, about 100 meters."),
        ...
        CaminoDestination(day: 36, date: Self.dateFormatter.date(from: "2025-06-06")!, locationName: "Santiago de Compostela", hotelName: "Hotel Alda Avenida",
            ...
            content: "From Hotel Rural O Acivro, head southwest along the Camino. Pass O Pedrouzo (2 km), climb to Monte do Gozo (15 km), and descend into Santiago de Compostela (20 km). Arrive near Praza do Obradoiro and the Cathedral. Your accommodation is located at Rúa Fonte de San Antonio, 5, about 400 meters.")
    ]
    
    public init(day: Int, date: Date, locationName: String, hotelName: String, coordinate: CLLocationCoordinate2D, elevationProfileAssetName: String, dailyDistance: Double, cumulativeDistance: Double, content: String = "") {
        self.day = day
        self.date = date
